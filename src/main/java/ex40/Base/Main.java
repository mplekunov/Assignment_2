...
public class Main {
    public static void main(String[] args) {
        ...
        printOutput(database.findByDate());
    }
    ...
    public static void printOutput(List<Employee> employees) {
        ...
        employees.forEach(o -> {
            ...
            String spacesSeparationDate = getWhitespaces(19 -
                    (o.getSeparationDate() != null ? dtf.format(o.getSeparationDate()).length() : 0));
            ...
            wrapper.output = wrapper.output.concat(String.format("%s %s%s|%s%s|%s%s\n",
                    ...
                    o.getSeparationDate() != null ? dtf.format(o.getSeparationDate()) : "", spacesSeparationDate));
        });
